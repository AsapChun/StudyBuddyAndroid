...
public class HomePageActivity extends AppCompatActivity {
    ...
    private static boolean checkname=true;
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                String class_d = (String) document.getData().get("ClassName");
                                String location_d = (String) document.getData().get("Location");
                                ArrayList<String> day_d = (ArrayList<String>) document.getData().get("Date");
                                String student_d = (String) document.getData().get("StudentId");
                                Boolean valid = (Boolean) document.getData().get("validAppointment");
                                Log.d(TAG, document.getId() + " appointment at " + location_d);
                                if(class_d!=null  ){
