...
public class Profile {
    ...
    public Profile(String first_name, String last_name, String gender, String cover_url, String image_url, String class_year, ArrayList<String> tutor_class, ArrayList<String> tutor_session, ArrayList<String> your_class ){
